...
For a VM deployment, put a reverse proxy (nginx/Caddy) with TLS in front of the container rather than exposing port 8080 directly — Dalux API keys will be flowing over this connection on every request.
