...
class DaluxFileService:
    ...
    def get_metadata(self, project_id: str, file_area_id: str, file_id: str) -> Dict[str, Any]:
        ...
        response = self._files_api.get_file(project_id, file_area_id, file_id)
        if response is None or response.data is None:
            return {}
        return response.data.model_dump(by_alias=True)
    ...
    def list_all_files(
        ...
        return self._files_api.get_all_files(project_id, file_area_id, params=params)
    ...
    def download(self, file_id: str, data: Dict[str, Any]) -> Optional[str]:
        ...
        path = self._files_api.download_file_from_link(
            download_link, file_name, self._download_dir
        )
